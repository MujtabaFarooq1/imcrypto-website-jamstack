...
import "./blogDetailPagination.scss";

const BlogDetailPagination = ({ nextNodeSlug, prevNodeSlug }) => {
  // console.clear();
  // console.log(nextNodeSlug, prevNodeSlug);
  ...
  return (
    <div>
      <div className="blogPagination">
        <a
          href={`${
            prevNodeSlug ? `/blog/${prevNodeSlug}` : "javascript:void(0)"
          }`}
          className={`blogPagination__btn blogPagination__btn--end ${
            prevNodeSlug
              ? "blogPagination__btn blogPagination__btn--end--active"
              : ""
          } `}
        >
          <svg
        ...
        <a
          href={`${
            nextNodeSlug ? `/blog/${nextNodeSlug}` : "javascript:void(0)"
          }`}
          className={`blogPagination__btn blogPagination__btn--end ${
            nextNodeSlug
              ? "blogPagination__btn blogPagination__btn--end--active"
...
export default BlogDetailPagination;
